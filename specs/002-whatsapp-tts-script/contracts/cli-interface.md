...
# Processing error
# Output: Error: Audio processing failed
echo $?  # Output: 4
```
...
- Extension: `.mp3` (always lowercase)

**File Format**:
- Format: MP3
- Generated by gTTS (Google Text-to-Speech)
...
# Test 4: File is MP3 format
OUTPUT=$(python tts.py "test")
file "$OUTPUT" | grep -q "MP3" && echo "PASS" || echo "FAIL"
